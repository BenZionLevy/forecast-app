...
if st.button("🔮 הפעל מודל חיזוי AI עכשיו", type="primary", use_container_width=True):
    ...
    if not df_actual.empty:
        ...
        fig.add_vline(x=str(last_train_date), line_width=2, line_dash="dot", line_color="#94a3b8", annotation_text="נקודת החיתוך (כאן המודל עוור)", annotation_position="top left")
